...
echo "La maison prés de la fontaine => "  . KataVerlan::actionOption("La maison prés de la fontaine") . "\n";
echo "La moquette de demain => "  . KataVerlan::actionOption("La moquette de demain") . "\n";
echo "Une voiture futuriste => "  . KataVerlan::actionOption("Une voiture futuriste") . "\n";
